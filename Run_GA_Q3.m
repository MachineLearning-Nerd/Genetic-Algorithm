...
%     end
    ...
    saveas(gcf, ['Q3analysis/Surface_mut_' num2str(gen_max_val) '.png'])
    %%
%     figure(3); clf;
    figure,
    g=1:1:length(scoreS);
    ...
    title(['For Gen-Max', num2str(gen_max_val)])
    saveas(gcf, ['Q3analysis/Analysis_mut_' num2str(gen_max_val) '.png'])
